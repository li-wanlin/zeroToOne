...
import com.jnl.mapper.DisplayImgMapper;
import com.jnl.service.DisplayImgService;
...
public class DisplayImgServiceImpl extends ServiceImpl<DisplayImgMapper, DisplayImg> implements DisplayImgService {
    ...
    /**
     * catalogNumber:1为注册登记信息，返回一张图片；2为水库基本信息，返回5张图片；3为电站基本信息，返回5张图片；
     * 4为水库风光，返回5张图片；
     * @param catalogNumber
     * @return
     */
    ...
    public DisplayImgResponse selectDisplay(Integer catalogNumber) {
        ...
        try {
            ...
            if (listOne.contains(catalogNumber)){
                ...
                String location = "http://39.165.143.208:8027/JNLProgram/display/" + fileName;   //服务器地址
                //String location = "http://localhost:8080/JNLProgram/display/" + fileName;   //本地地址
            ...
            for (DisplayImg displayImg: displayImgs) {
                locations.add("http://39.165.143.208:8027/JNLProgram/display/" + displayImg.getFileName());  //服务器地址

                //locations.add("http://localhost:8080/JNLProgram/display/" + displayImg.getFileName());  //本地地址
