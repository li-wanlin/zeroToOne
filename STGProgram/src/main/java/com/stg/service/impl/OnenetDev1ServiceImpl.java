...
import com.stg.entity.OnenetDev1;
import com.stg.mapper.OnenetDev1Mapper;
import com.stg.mapper.RainFallDataMapper;
import com.stg.service.OnenetDev1Service;
    ...
    public DevUnit selectLatest() {
        ...
        try {
            ...
            if (devs != null && devs.size() > 0){
                RainUnit rainUnit = this.selectRealTimeRain();
