...
import com.stg.service.impl.EduTrainServiceImpl;
import com.stg.vo.eduVo.EduResponse;
import com.stg.vo.functionVo.Meta;
import com.stg.vo.patrolVo.EduImgResponse;
...
public class EduTrainController {
    ...
    public Meta insertByEdu(EduTrain edu,@RequestParam(value = "files",required = false) MultipartFile[] files){
        Meta meta = new Meta();
/*        logger.info("这是执法巡查除文件以外的数据：{}", JSON.toJSONString(edu));
        if (files == null){
